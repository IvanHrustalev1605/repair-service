...
open class DriverDto() {
    ...
    open var personInfo: PersonInfoDto? = null
    ...
    override fun toString(): String {
        return "DriverDto(id=$id, licenseNumber=$licenseNumber, licenseExpiryDate=$licenseExpiryDate, vehicleType=$vehicleType, rating=$rating, position=$position, cars=$cars)"
    }
